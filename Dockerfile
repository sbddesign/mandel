...
ENV CDK_MINTD_AUTH_OPENID_DISCOVERY=https://mandel-keycloak.onrender.com/realms/cdk-test-realm/.well-known/openid-configuration
ENV CDK_MINTD_AUTH_OPENID_CLIENT_ID=cashu-client
ENV CDK_MINTD_AUTH_MINT_MAX_BAT=50
ENV CDK_MINTD_AUTH_ENABLED=true
...
ENV CDK_MINTD_AUTH_MINT="blind"
ENV CDK_MINTD_AUTH_GET_MINT_QUOTE="blind"
