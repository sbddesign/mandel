...
mkdir -p /opt/render/project/src/ldk_node_data
...
if [ ! -L /usr/src/app/ldk_node_data ]; then
    ...
    ln -sf /opt/render/project/src/ldk_node_data /usr/src/app/ldk_node_data
fi

# Set the LDK Node data directory environment variable
export CDK_MINTD_LDK_NODE_DATA_DIR=/opt/render/project/src/ldk_node_data
